...
# Logging setup
# ---------------------------------------
# Configurable logging: supports both human-readable text and machine-parseable JSON formats
...
# ---------------------------------------
# Adds HTTP request/response logging with request ID tracing for debugging
